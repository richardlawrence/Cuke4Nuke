...
The other option you have to run Cucumber on .NET is via IronRuby. This is a bit slower, since
IronRuby takes a while to start. This will not use Cuke4Nuke.
